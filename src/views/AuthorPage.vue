    ...
    <div class="author">
      ...
      <div>
        <div class="author-info">
          <!-- <span class="author-header" v-bind:style="{ backgroundImage: `url(${getAuthorBackgroundById(author.userid)})` }"></span> -->
          <span class="author-header-test"></span>
...
.author-background {
  ...
  background-image: url(F:\zuoye\VueFinal-CourseDesign-master\src\assets\OrangeLogo.png); 
}
